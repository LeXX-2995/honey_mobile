...
@__DSOCacheEntry_name.4 = internal constant [18 x i8] c"libopencv_java.so\00", align 1
...
@__DSOCacheEntry_name.9 = internal constant [19 x i8] c"libDXGridNative.so\00", align 1
...
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	; 3
	%struct.DSOCacheEntry {
		i64 363551746, ; hash 0x15ab5c02, from name: opencv_java.so
		i8 0, ; ignore
	...
	; 14
	%struct.DSOCacheEntry {
		i64 1840654184, ; hash 0x6db62768, from name: libopencv_java.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 18
	%struct.DSOCacheEntry {
		i64 2361478822, ; hash 0x8cc14ea6, from name: opencv_java
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 3113369406, ; hash 0xb9923f3e, from name: libopencv_java
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
