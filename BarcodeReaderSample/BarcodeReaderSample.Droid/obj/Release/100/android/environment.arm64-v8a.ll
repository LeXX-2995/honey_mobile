...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"05367fb6-c259-4468-bb3c-221980f082ca\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"uz.traceiq.mobile.expeditor\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100673212, ; jnienv_initialize_method_token
	i32 100673211, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.1 = internal constant [18 x i8] c"libopencv_java.so\00", align 1
@__DSOCacheEntry_name.2 = internal constant [23 x i8] c"libDXListViewNative.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [22 x i8] c"libDXEditorsNative.so\00", align 1
...
@__DSOCacheEntry_name.7 = internal constant [19 x i8] c"libDXGridNative.so\00", align 1
...
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 295403500301625017, ; hash 0x4197beb1ce2a6b9, from name: libopencv_java
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 3457751488812127166, ; hash 0x2ffc66a8bc3993be, from name: opencv_java
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 22
	%struct.DSOCacheEntry {
		i64 10094306748705708041, ; hash 0x8c162e818a6e9809, from name: libopencv_java.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 39
	%struct.DSOCacheEntry {
		i64 18243396153317688267, ; hash 0xfd2d9024cf3a83cb, from name: opencv_java.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}
